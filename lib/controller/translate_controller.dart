...
class TranslateController extends GetxController {
  ...
  Future<void> translate() async {
    if (textC.text.trim().isNotEmpty && to.isNotEmpty) {
      ...
      if (to.isEmpty) MyDialog.info('Тил танданыз!');
      if (textC.text.isEmpty) MyDialog.info('Которулуучу созду жазыныз!');
    }
  }
  ...
  Future<void> googleTranslate() async {
    if (textC.text.trim().isNotEmpty && to.isNotEmpty) {
      ...
      resultC.text = await APIs.googleTranslate(
          ...
          to: jsonLang[to.value] ?? 'ky',
          text: textC.text);

      status.value = Status.complete;
    } else {
      status.value = Status.none;
      if (to.isEmpty) MyDialog.info('Тилди танданых!');
      if (textC.text.isEmpty) {
        MyDialog.info('Которулуучу созду жазыныз!');
      }
    }
  }
